...
## Language
- [python basic](https://github.com/hathatinggroot/python-basic)


## legacy
- [clubmanager](https://github.com/hathatinggroot/clubmanager)
- [mvc board](https://github.com/hathatinggroot/mvc_model2_board)
